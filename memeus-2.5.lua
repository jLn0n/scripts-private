...
--Edit again by JohnLennonPlayz#1464
...
local joyemoji = Instance.new('ParticleEmitter', Torso)
...
local LIT = Instance.new('ParticleEmitter', Torso)
...
local ok = Instance.new('ParticleEmitter', Torso)
...
local function CreateSound(ID, PARENT, VOLUME, PITCH) --Very important.
	local NSound = nil
	coroutine.resume(coroutine.create(function()
...
local chargeup = Instance.new("Sound", hed)
...
local meme = Instance.new("Sound", hed)
...
local Cause_Im_having_a_good_time_having_a_good_time = Instance.new("Sound", hed) --DONT STOP ME NOOOOOOOOOWWWWWWWW
...
local STHAP = Instance.new("Sound", hed)
STHAP.SoundId = "http://www.roblox.com/asset/?id=1591656314"
STHAP.Volume = 10
STHAP.Pitch = 1
STHAP.Looped = false

local forevergone = Instance.new("Sound", Torso)
...
-------------------------------------------------------
local sine=0
local function HitboxFunction(Pose, lifetime, siz1, siz2, siz3, Radie, Min, Max, kb, atype)
...
local function GEtOuT()
	...
	Humanoid.WalkSpeed = 10
		...
		local vel3 = Instance.new("BodyVelocity",Torso)
	...
	for i = 0,12,0.1 do
		...
		CameraEnshaking(1, 2)
			HitboxFunction(ll.CFrame, 0.01, 1, 1, 1, 7, 20, 99, 53, "Knockdown")
				...
				Torso.Neck.C0 = clerp(Torso.Neck.C0, necko * angles(Rad(-40), Rad(0), Rad(0)), 0.3)
...
local function Flight() --wowthatsdiffrent
	attack = true
...
local function ShutTheHellUp()
	attack = true
	Humanoid.WalkSpeed = 2.01
...
local function SpinMeDad() --YOU SPIN ME RIGHT ROUND BABY RIGHT ROUND
	attack = true
	Humanoid.WalkSpeed = 5
		Humanoid.JumpPower = 175
		Character.Head.face.Texture = "rbxassetid://1223903433"
	CreateSound("145799973", hed, 10, 1)
		local vel2 = Instance.new("BodyVelocity",Torso)
...
local function EndMySufferingV2() --why
	attack = true
	Humanoid.WalkSpeed = 1.01
...
local function HELP()
	...
	for i = 0,8,0.1 do
		...
		wait()
		rootj.C0 = clerp(rootj.C0, RootCF * CF(0, 0, -0.1 + 0.1) * angles(Rad(0), Rad(0), Rad(0)), 0.15)
		Torso.Neck.C0 = clerp(Torso.Neck.C0, necko * angles(Rad(60), Rad(0), Rad(0)), 0.3)
		RH.C0 = clerp(RH.C0, CF(0.7, -0.01 - 0.1 , 0.025 * Cos(sine / 20)) * RHCF * angles(Rad(-2.5), Rad(0), Rad(0)), 0.15)
		LH.C0 = clerp(LH.C0, CF(-0.7, -0.01 - 0.1 , 0.025 * Cos(sine / 20)) * LHCF * angles(Rad(-2.5), Rad(0), Rad(0)), 0.15)
		RW.C0 = clerp(RW.C0, CF(0.9, 0.5 + 0.05 * Sin(sine / 30), 0.025 * Cos(sine / 20)) * angles(Rad(0), Rad(0), Rad(0)), 0.1)
		LW.C0 = clerp(LW.C0, CF(-0.9, 0.5 + 0.05 * Sin(sine / 30), 0.025 * Cos(sine / 20)) * angles(Rad(0), Rad(0), Rad(0)), 0.1)
...
local function MYSPAGHETTTTTTT() --ow
	attack = true
	Humanoid.WalkSpeed = 1.01
...
local function hap() --much hap
	attack = true
	Humanoid.WalkSpeed = 0.10
	CreateSound("363808674", hed, 10, 1)
		Character.Head.face.Texture = "rbxassetid://315792941"
	for i = 0,12,0.1 do
		wait()
		rootj.C0 = clerp(rootj.C0, RootCF * CF(0, 0, -0.1 + 0.1) * angles(Rad(0), Rad(0), Rad(0)), 0.15)
		Torso.Neck.C0 = clerp(Torso.Neck.C0, necko * angles(Rad(-0), Rad(0), Rad(180)), 0.3)
		RH.C0 = clerp(RH.C0, CF(1, -0.9 - 0.1 , 0.025 * Cos(sine / 20)) * RHCF * angles(Rad(-2.5), Rad(0), Rad(0)), 0.15)
		LH.C0 = clerp(LH.C0, CF(-1, -0.9 - 0.1 , 0.025 * Cos(sine / 20)) * LHCF * angles(Rad(-2.5), Rad(0), Rad(0)), 0.15)
		RW.C0 = clerp(RW.C0, CF(1.5, 0.5 + 0.05 * Sin(sine / 30), 0.025 * Cos(sine / 20)) * angles(Rad(0), Rad(0), Rad(0)), 0.1)
...
local function HAAAAA() --KONO POWA
	attack = true
	Humanoid.WalkSpeed = 1.01
	...
	for i = 0,30,0.1 do
		...
		chargeup.Parent = hed
		rootj.C0 = clerp(rootj.C0, RootCF * CF(0, 0, -0.1 + 0.1) * angles(Rad(0), Rad(0), Rad(0)), 0.15)
		Torso.Neck.C0 = clerp(Torso.Neck.C0, necko * angles(Rad(15), Rad(0), Rad(0)), 0.3)
	...
	local tra = trazx:clone()
	tra.Parent = Character.HumanoidRootPart
	...
	for i = 0,32,0.1 do
		...
		chargeup.Parent = hed
		rootj.C0 = clerp(rootj.C0, RootCF * CF(0, 0, -0.1 + 0.1) * angles(Rad(0), Rad(0), Rad(0)), 0.15)
		Torso.Neck.C0 = clerp(Torso.Neck.C0, necko * angles(Rad(-65), Rad(0), Rad(0)), 0.3)
		RH.C0 = clerp(RH.C0, CF(1.1, -0.9 - 0.1 , 0.025 * Cos(sine / 20)) * RHCF * angles(Rad(-20), Rad(0), Rad(0)), 0.15)
		LH.C0 = clerp(LH.C0, CF(-1.1, -0.9 - 0.1 , 0.025 * Cos(sine / 20)) * LHCF * angles(Rad(-20), Rad(0), Rad(0)), 0.15)
		RW.C0 = clerp(RW.C0, CF(1.4, 0.0000000005 + 0.05 * Sin(sine / 30), 0.025 * Cos(sine / 20)) * angles(Rad(150), Rad(0), Rad(0)), 0.1)
		LW.C0 = clerp(LW.C0, CF(-1.4, 0.0000000005 + 0.05 * Sin(sine / 30), 0.025 * Cos(sine / 20)) * angles(Rad(150), Rad(0), Rad(-0)), 0.1)
...
local function NEN()
	...
	for i = 0,4,0.1 do
		...
		CameraEnshaking(1, 3)
		rootj.C0 = clerp(rootj.C0, RootCF * CF(0, 0, -0.1 + 0.1) * angles(Rad(0), Rad(0), Rad(0)), 0.15)
		Torso.Neck.C0 = clerp(Torso.Neck.C0, necko * angles(Rad(-90), Rad(0), Rad(0)), 0.3)
		RH.C0 = clerp(RH.C0, CF(1, -0.9 - 0.1 , 0.025 * Cos(sine / 20)) * RHCF * angles(Rad(-2.5), Rad(0), Rad(0)), 0.15)
		LH.C0 = clerp(LH.C0, CF(-1, -0.9 - 0.1 , 0.025 * Cos(sine / 20)) * LHCF * angles(Rad(-2.5), Rad(0), Rad(0)), 0.15)
...
local function FLYSKYHIGH()
	...
	for i = 0,300,0.1 do --thatsalongtime
		...
		rootj.C0 = clerp(rootj.C0, RootCF * CF(0, 0, -0.1 + 0.1) * angles(Rad(0), Rad(0), Rad(0)), 0.15)
		Torso.Neck.C0 = clerp(Torso.Neck.C0, necko * angles(Rad(-0-255.45*i), Rad(0), Rad(0)), 0.3)
...
local function highnoon()
	...
	CameraEnshaking(2, 4)
	local Blobby = Instance.new("Part", Character)
	Blobby.Name = "Blob"
	...
	for i = 0,7.75,0.1 do
		...
		Torso.Neck.C0 = clerp(Torso.Neck.C0, necko * angles(Rad(30), Rad(0), Rad(0)), 0.2)
...
local function somuchcancerwhy() --o no
	attack = true
	Humanoid.WalkSpeed = 0.10
	...
	for i = 0,100,0.1 do
		wait()
	 	CameraEnshaking(2, 3)
		ohno.Parent = hed
		Character.Torso.Neck.C0 = Character.Torso.Neck.C0 * CFrame.Angles(math.random(-10,10),math.random(-10,10),math.random(-10,10))
	end
	attack = false
	ohno:Stop()
	Character.Head.face.Texture = "rbxassetid://620619801"
...
local function WRY() --WRYYYYYYY
	attack = true
	Humanoid.WalkSpeed = 0.30
...
local function WhatHuh()
	...
	for i = 0,4,0.1 do
		wait()
		rootj.C0 = clerp(rootj.C0, RootCF * CF(0, 0, -0.1 + 0.1) * angles(Rad(0), Rad(0), Rad(0)), 0.15)
		Torso.Neck.C0 = clerp(Torso.Neck.C0, necko * angles(Rad(0), Rad(26), Rad(0)), 0.3)
		RH.C0 = clerp(RH.C0, CF(1, -0.9 - 0.1 , 0.025 * Cos(sine / 20)) * RHCF * angles(Rad(-2.5), Rad(0), Rad(0)), 0.15)
		LH.C0 = clerp(LH.C0, CF(-1, -0.9 - 0.1 , 0.025 * Cos(sine / 20)) * LHCF * angles(Rad(-2.5), Rad(0), Rad(0)), 0.15)
		RW.C0 = clerp(RW.C0, CF(1.5, 0.5 + 0.05 * Sin(sine / 30), 0.025 * Cos(sine / 20)) * angles(Rad(0), Rad(0), Rad(120)), 0.1)
		LW.C0 = clerp(LW.C0, CF(-1.5, 0.5 + 0.05 * Sin(sine / 30), 0.025 * Cos(sine / 20)) * angles(Rad(0), Rad(0), Rad(-120)), 0.1)
	...
	for i = 0,1,0.1 do
		wait()
		rootj.C0 = clerp(rootj.C0, RootCF * CF(0, 0, -0.1 + 0.1) * angles(Rad(0), Rad(0), Rad(0)), 0.15)
		Torso.Neck.C0 = clerp(Torso.Neck.C0, necko * angles(Rad(40), Rad(-26), Rad(0)), 0.3)
		RH.C0 = clerp(RH.C0, CF(1, -0.9 - 0.1 , 0.025 * Cos(sine / 20)) * RHCF * angles(Rad(-2.5), Rad(0), Rad(0)), 0.15)
		LH.C0 = clerp(LH.C0, CF(-1, -0.9 - 0.1 , 0.025 * Cos(sine / 20)) * LHCF * angles(Rad(-2.5), Rad(0), Rad(0)), 0.15)
		RW.C0 = clerp(RW.C0, CF(1.5, 0.5 + 0.05 * Sin(sine / 30), 0.025 * Cos(sine / 20)) * angles(Rad(0), Rad(0), Rad(120)), 0.1)
		LW.C0 = clerp(LW.C0, CF(-1.5, 0.5 + 0.05 * Sin(sine / 30), 0.025 * Cos(sine / 20)) * angles(Rad(0), Rad(0), Rad(-120)), 0.1)
...
local function NothingPersonal()
	if mouse.Target.Parent ~= Character and mouse.Target.Parent.Parent ~= Character and mouse.Target.Parent:FindFirstChildOfClass("Humanoid") ~= nil then
		local HITBODY = mouse.Target.Parent
		local HitTorso = HITBODY:FindFirstChild("Torso") or HITBODY:FindFirstChild("UpperTorso")
		local HEAD = HITBODY:FindFirstChild("Head")
		local HUMAN = mouse.Target.Parent:FindFirstChildOfClass("Humanoid")
		if HitTorso ~= nil and HUMAN ~= nil then
			attack = true
			root.CFrame = HitTorso.CFrame * CFrame.new(-1,0,3)
			HitTorso.Anchored = true
		...
		for _ = 0,9,0.1 do
			...
			for _ = 1,2 do
				...
				CameraEnshaking(1, 7)
				Effects.Sphere.Create(BrickColor.new("Persimmon"), HitTorso.CFrame*CFrame.new(math.random(-200,200)/100,math.random(-300,200)/100,math.random(-100,100)/100), 1, 1, 1, 15, 15, 15, 0.2)
			end
		end
		wait(.5)
		HitTorso.Anchored = false
		attack = false
		Character.Head.face.Texture = "rbxassetid://620619801"
		Humanoid.WalkSpeed = 16
	end
...
local function VeryMuchWorrying()
	attack = true
	Humanoid.WalkSpeed = 1.01
...
local function Ashes() --Straight from... Whatever it was called.
		attack = true
	Humanoid.WalkSpeed = 1.01
		Character.Head.face.Texture = "rbxassetid://360687027"
	CreateSound("290084602", Torso, 10, 1)
	for i = 0,6.2,0.1 do
			wait()
...
local function AnotherOne() --WhAT ANOTHER ONE
	attack = true
	Humanoid.WalkSpeed = 1.01
...
local function kyu_will_break_your_neck_asdf_longest_function_name_ever_xd()
	attack = true
	...
	for i = 0,2,0.1 do
		...
		Torso.Neck.C0 = clerp(Torso.Neck.C0, necko * angles(Rad(10), Rad(40), Rad(0)), 0.4)
		RH.C0 = clerp(RH.C0, CF(1, -0.9 - 0.1 , 0.025 * Cos(sine / 20)) * RHCF * angles(Rad(-2.5), Rad(0), Rad(0)), 0.15)
		LH.C0 = clerp(LH.C0, CF(-1, -0.9 - 0.1 , 0.025 * Cos(sine / 20)) * LHCF * angles(Rad(-2.5), Rad(0), Rad(0)), 0.15)
	...
	warn("Seems like you just died.")
end

local MoreTaunts = false
...
while true do
	...
	if equipped == true or equipped == false then
		...
		if humState == "runningnophysics" then humState = "running" end
		if humState == "jumping" then
			if attack == false then
